...
export class GttCreateEvent extends BaseEvent {
    ...
    get symb(): string | undefined { return this._symb; }
    get qty(): number | undefined { return this._qty; }
    get ltp(): number | undefined { return this._ltp; }
    get sl(): number | undefined { return this._sl; }
    get ent(): number | undefined { return this._ent; }
    get tp(): number | undefined { return this._tp; }

    set symb(value: string | undefined) { this._symb = value; }
    set qty(value: number | undefined) { this._qty = value; }
    set ltp(value: number | undefined) { this._ltp = value; }
    set sl(value: number | undefined) { this._sl = value; }
    set ent(value: number | undefined) { this._ent = value; }
