...
function PlaceBinanceOrder() {
    ...
    let binanceOrder = new BinanceOrder(ticker, sl, entry, tp);
    placeBinanceOrder(binanceOrder.stopLoss());
    placeBinanceOrder(binanceOrder.entry());
    placeBinanceOrder(binanceOrder.takeProfit());
}