...
const reasons = ['dep', 'ooa', 'tiz', 'oe', 'tto', 'nca', 'tested', 'zn', 'max', 'base', 'er', 'nzn', 'nsprt', 'REC', 'WOW', 'MISS'];
...
// -- Events/Signals
// TODO: #B Create Event models (Currently Generic Maps). Eg. gttOrderEvent
