...
const reasons = ['dep', 'ooa', 'tiz', 'oe', 'tto', 'nca', 'tested', 'zn'];
...
const orderInfoStore = 'orderSilo';
const flagInfoStore = 'flagSilo';
const pairMapStore = "pairSilo";

// -- Events/Signals
const gttOrderEvent = "gttOrderEvent" //GTT Order Referesh
...
const tokenChangedEvent = "tokenChangedEvent"; //Auth Token of Investing
