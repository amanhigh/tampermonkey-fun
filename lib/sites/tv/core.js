...
function SetupTvUI() {
    ...
    buildWrapper('aman-top').appendTo(`#${areaId}`)
        ...
        .append(buildButton(refreshId, 'J', () => {
            toggleUI(`${journalId}`);
        }))
...
function journalUI() {
    buildWrapper(`${journalId}-type`).appendTo(`#${journalId}`)
        ...
        .append(buildButton('yr.trend', "Y-T", createCard).data('id', '5e3712cfb57c1210b4627055'))
        .append(buildButton('yr.ctrend', "Y-CT", createCard).data('id', '5e3712df7f1630869f9d559d'));
}