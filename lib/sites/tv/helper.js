...
function pinExchangeTicker(tvTicker, exchange) {
    dataSilo.tvPinMap[tvTicker] = `${value}:${tvTicker}`;
    message(`Pinned Ticker: ${tvTicker} to ${exchange}`.fontcolor('yellow'));
}
        ...
        if (actionSplit.length === 2) {
            ...
            switch (action) {
                ...
                case "A":
                    ...
                    pinAlertName(tvTicker, value);
                    break;
                case "P":
                    //Map Passed Exchange to Current TV Ticker
