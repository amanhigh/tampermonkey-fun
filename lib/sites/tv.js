...
function toggleSymbols(color, index) {
    ...
    let listSelector = `.listContainer-1OhjZIMS`;
    let lineSelector = `${listSelector} > div > div`;
    ...
    $(lineSelector).css('position', '');
    $(listSelector).css('overflow', '');
    switch (index) {
        case 1:
        ...
        case 3:
            ...
            $(listSelector).css('overflow', 'auto');
            break;
        default:
