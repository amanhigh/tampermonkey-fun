...
const alertNameStore = "alertNameMap";
...
function mapAlertName(tvTicker, alertName) {
    let alertNameMap = GM_getValue(alertNameStore, {});
    alertNameMap[alertName] = tvTicker;
    GM_setValue(alertNameStore, alertNameMap);
