...
const symbolFlagSelector = 'div.flagWrapper-1WIwNaDF';
const timeframeSelector = `#header-toolbar-intervals > div`;

//Name, Exchange, Prices
const nameSelector = 'div.mainTitle-1WIwNaDF';
const exchangeSelector = 'div.exchangeTitle-1WIwNaDF';

//Popups
const searchPopupSelector = 'input.search-Hsmn_0WX';
const replayActiveSelector = '#header-toolbar-replay.isActive-2Vpz_LXc';
...
const orderInputSelector = '.group-1l7R0vfy input';
...
//Watchlist
const watchListWidgetSelector = 'widgetbar-widgetbody:first';
const watchListSelector = `[class^=listContainer]`;
const watchListLineSelector = `${watchListSelector} > div > div`;
const watchListSymbolSelector = '[class*=symbolNameText]';
const watchListSelectedSelector = '[class*=selected]';
const flagSelector = "[class^=uiMarker]";
const flagMarkingSelector = `${flagSelector} > svg > path:nth(0)`;

//Toolbars
let styleSelector = 'div.floating-toolbar-react-widgets__button';
let styleItemSelector = `tr.item-f5BaKrKq`;
