...
const symbolFlagSelector = 'div.flagWrapper-14Sd7MtI';
...
//Popups
const exchangePopupSelector = '.exchangeName-ZzQNZGNo:first';
...
const autoAlertSelector = ".label-1If3beUH:contains(\'Add Alert\')"
...
const screenerButtonSelector = '.button-txUjKTqi:first';
...
const watchListSelectedSelector = '.selected-1d4hA4fK';
