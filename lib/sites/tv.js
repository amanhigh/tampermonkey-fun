...
function filterSymbols(color, index) {
    ...
    switch (index) {
        case 1:
            ...
            $(`${watchListLineSelector}:not(:has(${watchListSymbolSelector}[style*='color: ${color}']))`).hide();
            break;
        case 2:
        ...
        case 3:
            ...
            $(watchListLineSelector).show();
            $(`${watchListLineSelector}:not(:has(${watchListFlagSelector}[style*='color: ${color}']))`).hide();
            break;
        default:
...
function paintTVWatchList() {
    ...
    //Mark Gold Flags
    $(`${watchListNameSelector}:contains("XAUUSD")`).find(watchListFlagSelector).css('color',colorList[0]);
