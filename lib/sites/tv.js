...
function setupFastAlertUI() {
    ...
    buildWrapper('aman-top').appendTo(`#${areaId}`)
        ...
        .append(buildButton(refreshId, 'T',() =>{toggleUI('#aman-trello')}))
...
function trelloSectionUI() {
    //Trello Section
    buildWrapper('aman-trello').appendTo(areaId);

    buildWrapper('aman-trello-list').appendTo('#aman-trello');
    buildRadio('Set', "5b0fb8122611996bf3b1eb3b", "trello-list", false).appendTo('#aman-trello-list')
    buildRadio('Not Taken', "5cfb58544c0c65863097655f", "trello-list", true).appendTo('#aman-trello-list')

    buildWrapper('aman-trello-type').appendTo('#aman-trello');
    buildButton('MWD-T-F', "MWD-T-F", createCard).data('id', '5e37123b78179482bfbaba7c').appendTo('#aman-trello-type')
    buildButton('MWD-CT-F', "MWD-CT-F", createCard).data('id', '5e371210e096bb0fc7feb409').appendTo('#aman-trello-type')
    buildButton('WDH2-T-F', "WDH2-T-F", createCard).data('id', '5e3712cfb57c1210b4627055').appendTo('#aman-trello-type')
    buildButton('WDH2-CT-F', "WDH2-CT-F", createCard).data('id', '5e3712df7f1630869f9d559d').appendTo('#aman-trello-type')
}